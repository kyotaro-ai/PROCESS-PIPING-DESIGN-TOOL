...
if language == "日本語":
    ...
    TXT = {
        ...
        "isometric_guide": "アイソメガイド",

        "isometric_route": "アイソメルート入力",

        "preview": "プレビュー",

        "route_preview": "ルートプレビュー",
        
        "route_preview_caption": "Direction + Lengthから生成",
    ...
    TXT = {
        ...
        "isometric_guide": "Guide",

        "isometric_route": "Isometric Route Input",

        "preview": "Preview",

        "route_preview": "Route Preview",
        
        "route_preview_caption": "Generated from Direction + Length",
...
if not is_mobile:
    ...
    for px, py in mini_route_points:
    ...
    if len(mini_route_points) > 1:
        ...
        xs = [p[0] for p in mini_route_points]
        ys = [p[1] for p in mini_route_points]
...
plot_title = TXT["route_preview"]

plot_caption = TXT["route_preview_caption"]
